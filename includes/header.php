<div class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.php"><span class="glyphicon glyphicon-fire"></span>E-Store</a>
        </div>
        <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav navbar-right">
                ...
                if (isset($_SESSION['email'])) {
                    ...
                    <li><a href="About.php"><span class="glyphicon glyphicon-align-center"></span> About Us</a></li>
