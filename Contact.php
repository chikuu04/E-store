...
<div class="row" >
	<div class="container" style="margin-top: 10px; padding: 20px; border: 3px solid #bbb ">
		...
		<div class="col-sm-6 col-xs-12" >
			...
			<form method="post"  action="cont.php">
				...
				<div class="form-group">
					...
					<button class="btn btn-success" type="submit" value="Submit"  name="button">Submit</button>						
						</button>
